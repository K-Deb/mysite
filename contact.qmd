...
Department of Mathematics, School of Basic and Applied Sciences, Adamas University
...
suppressWarnings(leaflet() %>%
  ...
  addMarkers(lng=88.45655905044401, lat=22.73847079410535, popup="Department of Mathematics"))
```
:::
